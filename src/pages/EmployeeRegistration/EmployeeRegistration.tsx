...
import { Organization, OrganizationLoc, RegisterResponse } from "./EmployeeRegistration.types";
import { MenuProps, styles } from "./EmployeeRegistration.style";
...
const EmployeeRegistration = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      employee_id:Yup.string().required("Employee Id is required").min(5, "At least 5 characters be there")
      .max(8, "Upto 8 characters long"),
    }),
